...
export const LiquidButton: React.FC<LiquidButtonProps> = ({ 
  ...
  return (
    <div className={cn("relative inline-block w-36 h-[2.7em] group", className)}>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[40%] w-[92.23%] h-[112.85%] rounded-lg bg-[#1a0a00] filter blur-[7.3px]"></div>
      <div className="relative w-full h-full overflow-hidden rounded-lg">
        ...
        <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[40%] w-[70.8%] h-[42.85%] rounded-lg filter blur-[15px] bg-[#331a00]"></span>
      </div>
      <button
      ...
      >
        <span className="flex items-center justify-center gap-2 rounded-lg text-amber-200 group-hover:text-amber-400 text-lg font-semibold tracking-wide whitespace-nowrap transition-colors">
          {children}
        </span>
      </button>
    </div>
