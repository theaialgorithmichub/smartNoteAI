...
const templateIconMap: Record<NotebookTemplateType, React.ReactNode> = {
  ...
  'project-builder': <FolderKanban size={20} />,
  'second-brain-daily-log': <CalendarDays size={20} />,
  'narrative-storyboard': <ClipboardList size={20} />,
  'piano-virtuoso': <Music size={20} />,
  'dev-flow-architect': <Code2 size={20} />,
  'cinematic-storyboarder': <Video size={20} />,
  'meeting-strategist': <Mic size={20} />,
  'research-synthesizer': <Brain size={20} />,
  'workflow-automator': <Workflow size={20} />,
  'stock-pulse': <Zap size={20} />,
  'language-bridge': <Languages size={20} />,
  'carrom-coach': <Target size={20} />,
