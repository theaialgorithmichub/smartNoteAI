...
import { Globe, Users, BookOpen, User, Calendar, Eye } from 'lucide-react';
...
export function SharedNotebooksView({
  ...
  const [activeTab, setActiveTab] = useState<'shared' | 'public'>('shared');
  ...
  const currentNotebooks = activeTab === 'shared' ? sharedWithMe : publicNotebooks;
