...
export function AIChatSection() {
  ...
  const getAIResponse = (question: string): string => {
    ...
    if (lowerQuestion.includes('feature') || lowerQuestion.includes('what can')) {
      return "SmartNote AI offers powerful features including AI-powered note-taking, smart search, auto-organization, notebook templates, and collaborative tools. You can create beautiful digital notebooks with the nostalgic feel of physical ones!";
      ...
      return "I'm Note E, your AI-powered assistant! I can help you with smart search, auto-categorization, content summaries, and answering questions about SmartNote AI features.";
    } else {
      return "That's a great question! SmartNote AI is designed to revolutionize your note-taking experience with AI-powered features. Would you like to know more about our features, pricing, or how to get started?";
    }
  };
