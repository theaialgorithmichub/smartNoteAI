...
export const NOTEBOOK_TEMPLATES: NotebookTemplate[] = [
  ...
  },
  {
    id: 'custom',
    name: 'Custom Page',
    description: 'Build flexible pages from widgets like text, images, tasks, links, and code',
    icon: 'Blocks',
    color: 'indigo',
    features: ['Widget builder', 'Custom layouts', 'Tasks & links', 'Reusable pages'],
  },
  {
    id: 'project',
    name: 'Project',
  ...
  },
  {
    ...
    description: 'Plan cinematic stories with characters, scenes, environments, shots, and dialogue',
    icon: 'Film',
    color: 'purple',
    features: ['Scene planning', 'Character boards', 'Shot lists', 'AI prompts'],
  },
  {
    id: 'typewriter',
    name: 'Typewriter',
  ...
  },
  {
    id: 'n8n',
    name: 'n8n Workflows',
    description: 'Design, store, and export automation workflow ideas as n8n-ready JSON',
    icon: 'Workflow',
    color: 'indigo',
    features: ['Workflow canvas', 'JSON export', 'Node library', 'Automation planning'],
  },
  {
    id: 'image-prompt',
    name: 'Image Prompts',
    description: 'Organize AI image prompts, generated visuals, tags, and prompt iterations',
    icon: 'ImageIcon',
    color: 'rose',
    features: ['Prompt library', 'Image gallery', 'AI generation', 'Tagging'],
  },
  {
    id: 'video-prompt',
    name: 'Video Prompts',
    description: 'Manage video prompt ideas, reference clips, uploads, and production notes',
    icon: 'Video',
    color: 'blue',
    features: ['Prompt library', 'Video references', 'Upload support', 'Production notes'],
  },
  {
    id: 'studybook',
    name: 'Study Book',
